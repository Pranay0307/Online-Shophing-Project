...
public class DAO {
	...
	public static Connection getCon() {
		...
		try {
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/shop24", "root", "Ashu@Mysql8275");
	...
	public static Vector validate() {
		...
		try {
			...
			jrs.setUrl("jdbc:mysql://localhost:3306/shop24");
			jrs.setUsername("root");
			jrs.setPassword("Ashu@Mysql8275");
			jrs.setCommand("select email, password from user");
			jrs.execute();
